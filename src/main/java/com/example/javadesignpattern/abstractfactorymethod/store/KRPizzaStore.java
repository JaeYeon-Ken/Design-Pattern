...
import com.example.javadesignpattern.abstractfactorymethod.factory.KRPizzaIngredientFactory;
...
public class KRPizzaStore extends PizzaStore {
  ...
  public Pizza createPizza(String type) {
    ...
    PizzaIngredientFactory pizzaIngredientFactory = new KRPizzaIngredientFactory();
